...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> TYPE = createField(DSL.name("TYPE"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");

    /**
     * The column <code>LINK.LAST_POLLED</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_POLLED = createField(DSL.name("LAST_POLLED"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
